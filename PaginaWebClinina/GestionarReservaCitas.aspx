<%@ Page Title="" Language="C#" MasterPageFile="~/Home.Master" AutoEventWireup="true" CodeBehind="GestionarReservaCitas.aspx.cs" Inherits="PaginaWebClinina.GestionarReservaCitas" ClientIDMode="Static" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:UpdatePanel ID="upPanel" runat="server">
        <ContentTemplate>
                        ...
                        <div class="box box-primary">
                            <div class="box-body">
                              <div class="form-group">
                                ...
                                <asp:TextBox ID="txtFolio" CssClass="form-control" runat="server" MaxLength="8"></asp:TextBox>
                                ...
                                <div class="form-group">
                                    <label>MASCOTA</label>
                                    <asp:TextBox ID="txtMascota" CssClass="form-control" runat="server" Enabled="false"></asp:TextBox>
                                </div>
                                <div class="form-group">
                                    <label>SEXO</label>
                    ...
                    <div class="col-md-6">
                        <div class="box box-primary">
                            <div class="box-body">
                                 ...
                                 <div class="form-group">
                                    <label>RUT</label>
                                   <asp:TextBox ID="txtRut" CssClass="form-control" runat="server" Enabled="false"></asp:TextBox>
                                </div>
                                            ...
                                            <Columns>
                                                ...
                                                <asp:TemplateField>
                                                    ...
                                                    <ItemTemplate>
                                                        ...
                                                        <asp:Label ID="lblMedico" runat="server" Text='<%#Eval("Medico.Nombre")+ " " +Eval("Medico.ApPaterno") + " " + Eval("Medico.ApMaterno")%> '></asp:Label>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                                <asp:TemplateField>
                                                    <HeaderTemplate>
                                                        <asp:Label ID="lblDNIHeader" runat="server" Text="RUT"></asp:Label>
                                                    </HeaderTemplate>
                                                    <ItemTemplate>
            ...
            <asp:HiddenField ID="IdMascota" runat="server" />
        </ContentTemplate>
    </asp:UpdatePanel>
