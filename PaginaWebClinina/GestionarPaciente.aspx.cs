...
namespace PaginaWebClinina
{
    public partial class GestionarPaciente : System.Web.UI.Page
    {
        ...
        private Paciente GetEntity()
        {
            ...
            objPaciente.Mascota = new Mascota();
            objPaciente.Mascota.NombreMascota = txtMascota.Text;
            objPaciente.Mascota.SexoMascota = (ddlSexoMascota.SelectedValue == "Hembra") ? 'H' : 'M'; // Masculino , Femenino
            objPaciente.Mascota.Chip = Convert.ToInt32(txtChip.Text);
