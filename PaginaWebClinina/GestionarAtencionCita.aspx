<%@ Page Title="" Language="C#" MasterPageFile="~/Home.Master" AutoEventWireup="true" CodeBehind="GestionarAtencionCita.aspx.cs" Inherits="PaginaWebClinina.GestionarAtencionCita" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <section class="content invoice">
        <div class="row invoice-info">
            <div class="col-sm-3 invoice-col">
                <asp:Image ID="imgPaciente" runat="server" Height="200px" Width="200px" ImageUrl="~/img/perro.png" />
            </div>
        ...
        <div class="row">
            ...
            <div class="col-sm-12 invoice-col">
                ...
                <br />
                <asp:TextBox ID="txtDiagnostico" runat="server" TextMode="MultiLine" Width="100%" Height="200px"></asp:TextBox>
            </div>
    ...
    <asp:HiddenField ID="hfIdMascota" runat="server" Visible="false" />
</asp:Content>
