                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                <asp:DropDownList ID="ddlBuscar" runat="server" CssClass="form-control">
                                    ...
                                    <asp:ListItem>Rut Propietario</asp:ListItem>
                                </asp:DropDownList>
                            </div>
                        </div>
                        <div class="col-md-6">
                ...
                <table>
                    <tr>
                        ...
                        <td>
                            ...
                            <asp:Label ID="lblMascota" runat="server" Text='<%#Eval("Mascota.NombreMascota") %>' Font-Size="Medium"></asp:Label><br />
                            <strong>&nbsp;&nbsp;Folio:&nbsp;&nbsp;&nbsp;&nbsp;</strong>
                            <asp:Label ID="lblChip" runat="server" Text='<%#Eval("MascotaPaciente.Folio") %>' Font-Size="Medium"></asp:Label><br />
                            <strong>&nbsp;&nbsp;Fecha:&nbsp;&nbsp;&nbsp;&nbsp;</strong>
