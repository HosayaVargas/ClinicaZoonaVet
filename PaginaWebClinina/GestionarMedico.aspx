...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <section class="content-header">
        <h1 style="text-align: center">REGISTRO DE SERVICIOS</h1>
    </section>
            ...
            <div class="col-md-6">
                <div class="box box-primary">
                    <div class="box-body">
                        ...
                        <div class="form-group">
                            <asp:TextBox ID="txtTipoEmpleado" runat="server" Text="SERVICIOS" Enabled="false" CssClass="form-control"></asp:TextBox>
                        </div>
