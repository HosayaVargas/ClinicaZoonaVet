...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <section class="content-header">
        <h1 style="text-align: center">NUEVOS REGISTROS</h1>
    </section>
        ...
        <div style="width: 100%" class="row">
                ...
                <div class="box box-primary">
                    <div class="box-body">
                        <div class="form-group">
                            <label for="txtNroDocumento" class="formulario__label">RUT</label>
                        </div>
                        <div class="form-group">
                            <asp:TextBox ID="txtNroDocumento" runat="server" Text="" MaxLength="11" CssClass="form-control formulario__input"></asp:TextBox>
                            <asp:RegularExpressionValidator ID="evDNI" runat="server" ErrorMessage="El RUT debe contener máximo 8 digitos" ControlToValidate="txtNroDocumento" ForeColor="#FF3300" ValidationExpression="[0-8]{8}" ValidationGroup="DatosRequeridos"></asp:RegularExpressionValidator>
                        </div>
                        <div class="form-group">
            ...
            <div class="col-md-6">
                <div class="box box-primary">
                    <div class="box-body">
                         <div class="form-group">
                            <label for="txtMascota" class="formulario__label">MASCOTAS</label>
                        </div>
                        <div class="form-group">
                            <asp:TextBox ID="txtMascota" runat="server" Text="" CssClass="form-control formulario__input"></asp:TextBox>
                            <asp:RegularExpressionValidator ID="evMascota" runat="server" ErrorMessage="El nombre solo contiene letras y espacios" ControlToValidate="txtMascota" ForeColor="#FF3300" ValidationExpression="[a-zA-ZÀ-ÿ\s]{1,40}" ValidationGroup="DatosRequeridos"></asp:RegularExpressionValidator>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            <label for="txtChip" class="formulario__label">CHIP</label>
                        </div>
                        <div class="form-group">
                            <asp:TextBox ID="txtChip" runat="server" Text="" CssClass="form-control formulario__input"></asp:TextBox>
                            <asp:RegularExpressionValidator ID="RegularExpressionValidator1" runat="server" ErrorMessage="Ingrese una edad correcta" ControlToValidate="txtEdad" ForeColor="#FF3300" ValidationExpression="[0-9]{1,2}" ValidationGroup="DatosRequeridos"></asp:RegularExpressionValidator>
                        </div>
            ...
            <div class="col-xs-12">
                <div class="box box-primary">
                    ...
                    <div class="box-body table-responsive">
                        <table id="tbl_paciente" class="table table-bordered table-hover text-center">
                            <thead>
                                <tr>
                                    <th>Código</th>
                                    <th>Nombres</th>
